...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum UnderlineCode {
    On,
    Reset,
    Styled(StyledUnderline),
}
...
impl CharacterStyles {
    ...
    pub fn underline(mut self, underline_code: Option<UnderlineCode>) -> Self {
    ...
    pub fn add_style_from_ansi_params(&mut self, params: &mut ParamsIter) {
        while let Some(param) = params.next() {
            match param {
                ...
                [4] => *self = self.underline(Some(UnderlineCode::On)),
                [4, 0] => *self = self.underline(Some(UnderlineCode::Reset)),
                [4, 1] => *self = self.underline(Some(UnderlineCode::On)),
                [4, 2] => *self = self.underline(Some(UnderlineCode::Styled(StyledUnderline::Double))),
                [4, 3] => *self = self.underline(Some(UnderlineCode::Styled(StyledUnderline::Curly))),
                [4, 4] => *self = self.underline(Some(UnderlineCode::Styled(StyledUnderline::Dotted))),
                [4, 5] => *self = self.underline(Some(UnderlineCode::Styled(StyledUnderline::Dashed))),
                ...
                [24] => *self = self.underline(Some(UnderlineCode::Reset)),
                [25] => {
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        ...
        if let Some(ansi_code) = self.underline {
            match ansi_code {
                ...
                UnderlineCode::Styled(underline_style) => match underline_style {
